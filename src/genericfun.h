...
double fct_risq_base(double t,  int status, arma::vec& param_basehaz, int basehaz, arma::vec& knots_surv, int nE, arma::vec& gammaX, arma::mat& xti1_intY, arma::mat& xti2_intY, bool surv, int trans);
